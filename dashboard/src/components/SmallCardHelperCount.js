...
class HelpersInDbCount extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "Helpers en base de datos",
      value: null,
  ...
  async componentDidMount() {
    ...
    const helpersListData = await response.json();
    this.setState({
      value: helpersListData.count,
    });
  }
}

export default HelpersInDbCount;
